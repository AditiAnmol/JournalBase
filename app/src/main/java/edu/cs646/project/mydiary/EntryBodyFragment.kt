...
class EntryBodyFragment : Fragment() {

    private var band: Entry? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        band = EntryRepo.getInstance(requireContext()).getBand(bandId)
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View {
        val rootView = inflater.inflate(R.layout.fragment_entry_body, container, false)
